const SELECTOR = [
  '.landing:not(.auth-page) .lp-btn',
  '.landing:not(.auth-page) .lp-nav-links a',
  '.landing:not(.auth-page) .lp-command',
  '.landing:not(.auth-page) .lp-nav-profile-name',
  '.landing:not(.auth-page) p:not(.lp-chip):not(.lp-hero-lead)',
