...
const copy = {
  fr: {
    ...
    product: {
      chip: 'produit',
      h2: 'Le filtre qui fait tout le sale travail.',
      lead: 'Prospy ouvre chaque fiche Google Maps, suit le lien, et tranche. Les entreprises déjà équipées disparaissent avant que la liste arrive devant vous.',
    },
    sieve: {
      label: 'tri du web · en direct',
      ...
      kinds: {
        ...
        none: 'aucun lien nulle part',
      },
      note: 'Un vrai site part à la poubelle. Une page Facebook ou une fiche annuaire reste un prospect, parce que le patron n’a toujours rien à lui.',
    },
    band: {
      label: 'terrain',
      title: 'Une tournée, pas une liste.',
      note: 'Chaque point est une adresse sans site. La couleur donne le potentiel, et vous groupez vos appels quartier par quartier.',
      hot: 'à appeler d’abord',
      warm: 'bon',
      cold: 'plus tard',
    },
    preview: {
  ...
  en: {
    ...
    product: {
      chip: 'product',
      h2: 'The filter that does the dirty work.',
      lead: 'Prospy opens every Google Maps listing, follows the link, and rules on it. Businesses already online are gone before the list reaches you.',
    },
    sieve: {
